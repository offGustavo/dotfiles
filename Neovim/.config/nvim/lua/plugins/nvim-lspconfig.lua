    ...
    local ret = {
      ...
      servers = {
        ...
        ["*"] = {
          ...
          -- stylua: ignore
          keys = {
            { "<leader>cll", function() Snacks.picker.lsp_config() end, desc = "Lsp Info" },
            ...
            { "<leader>lcc", vim.lsp.codelens.run, desc = "Run Codelens", mode = { "n", "x" }, has = "codeLens" },
            { "<leader>lcC", vim.lsp.codelens.refresh, desc = "Refresh & Display Codelens", mode = { "n" }, has = "codeLens" },
