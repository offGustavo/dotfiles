...
function M.write_tmux_theme()
  ...
  local lines = {
    ...
    string.format('set -g status-left "#[fg=%s,bg=%s,bold] #S #[fg=%s,bg=%s,nobold,nounderscore,noitalics] "', colors.TMUX_BG, colors.TMUX_HL, colors.TMUX_HL, colors.TMUX_BG),
    string.format('set -g status-right "#[fg=%s,bg=%s,nobold,nounderscore,noitalics]#[fg=%s,bg=%s,bold]  %%d/%%m/%%y  %%H:%%M #[fg=%s,bg=%s,nobold,nounderscore,noitalics]#[fg=%s,bg=%s] #{?client_prefix, ,󰯉 } #[fg=%s,bg=%s,bold] #h "', colors.TMUX_BG, colors.TMUX_BG, colors.TMUX_FG, colors.TMUX_BG, colors.TMUX_ABG, colors.TMUX_BG, colors.TMUX_HL, colors.TMUX_ABG, colors.TMUX_BG, colors.TMUX_HL),
    ...
    string.format('setw -g window-status-format "#[fg=%s,bg=%s,nobold,nounderscore,noitalics]#[default] #I #W #[fg=%s,bg=%s,nobold,nounderscore,noitalics]"', colors.TMUX_BG, colors.TMUX_BG, colors.TMUX_BG, colors.TMUX_BG),
    string.format('setw -g window-status-current-format "#[fg=%s,bg=%s,nobold,nounderscore,noitalics]#[fg=%s,bg=%s,bold] #I #W #[fg=%s,bg=%s,nobold,nounderscore,noitalics]"', colors.TMUX_ABG, colors.TMUX_BG, colors.TMUX_HL, colors.TMUX_ABG, colors.TMUX_ABG, colors.TMUX_BG),
